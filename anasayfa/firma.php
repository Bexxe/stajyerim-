  ...
  <nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li><a class="dropdown-item text-center" href="../basvuru/firmabasvuru.php">Başvuranlar</a></li>
        <li><a class="dropdown-item text-center" href="../ilanlarim/ilanlarim.php">ilanlarım</a></li>
        <li><a class="dropdown-item text-center" href="../cikis.php">Çıkış Yap</a></li>
  </ul>
</div>
      </div>
              ...
              <div class="multibolum">
                  ...
                  <div id="bolumbox">
                    <label class="bolum" for="bilisim">
                      <input type="checkbox" id="bilisim" name="bolum[]" value="Bilişim" />Bilişim
                      <span class="checkmarkk"></span>
                    </label>
                    <label class="bolum" for="makine">
                      <input type="checkbox" id="makine" name="bolum[]" value="Makine" />Makine
                      <span class="checkmarkk"></span>
                    </label>
                    <label class="bolum" for="elektirik">
                      <input type="checkbox" id="elektirik" name="bolum[]" value="Elektrik" />Elektrik
                      <span class="checkmarkk"></span>
                    </label>
                  </div>
                </div>
