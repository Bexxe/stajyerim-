...
<body>
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
          ...
          <a href="../cikis.php"><div class="sec">Başvuranlar</div></a>
    ...
    <div class="ilan col-10">
      ...
      <?php echo '<div class="Bolum col-12">'.$row["bolum"].' Bölümü Stajyer Aranıyor</div>';?>
        <div class="basvuru col-12">
          <div class="col-12 col-sm-6 col-md-6 col-lg-4"><a href="../basvuru/basvuru.php?ilan_id=<?php echo $row["ilan_id"];?>"><button class="btn btn-primary basvur"><i class="fa-solid fa-pen-to-square"></i> Başvuran Öğrenciler</button></a></div>
        </div>
      </div>
