...
<body>
    ...
    <div class="row col-sm-0 col-md-12">
        ...
        <div class="baslik text-center">StajYer Giriş</div>
        <div class="box text-center">
            <form method="post">
                <input type="text" name="eposta" placeholder="E-posta"><br>
                <input type="password" name="sifre" placeholder="Şifre">
                <br>
                <button class="buton" name="buton" type="submit">Giriş Yap</button>
            </form>
            <?php
               if (isset($_POST['buton'])) {
                if (empty($_POST['eposta'])||empty($_POST['sifre'])) {
                  ...
                  $sql = "SELECT * FROM stajyerlertb WHERE eposta='$eposta' AND sifre='$sifre'";
                  ...
                  if (mysqli_num_rows($result) == 1) {
                    ...
                    $_SESSION['rol'] = 'stajyer';
                    $_SESSION['id'] = $row['id'];
                    $_SESSION['okul_id'] = $row['okul_id'];
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-7 col-xl-8 section-right">
            <center>
                <div class="inclusive">
                <div class="title">
                   Hemen Giriş Yap Kendine Uygun Staj Yapabileceğin Firma Bul :)
                </div>
                <div class="text">
