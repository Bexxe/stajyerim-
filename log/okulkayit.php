...
<body>
    ...
    <div class="row col-sm-0 col-md-12">
        ...
        <div class="baslik text-center">Okul Kayıt</div>
        <div class="box text-center">
            ...
            <select class="il" onchange="ilceGoster()" name="il" id="il">
              ...
              <option value="">Hangi Okulda Okuyorsunuz</option>
                ...
                <textarea name="adres" id="" cols="30" rows="2" placeholder="Okul Adres"></textarea>
            ...
            <?php
               if (isset($_POST['kayitbtn'])) {
                  ...
                  $sql = "SELECT * FROM okultb WHERE okul_eposta='$eposta' OR okul_tel='$telefon' OR okul_isim='$firma'";
                  ...
                  if (filter_var($eposta, FILTER_VALIDATE_EMAIL)) {
                    ...
                    $sql = "INSERT INTO okultb (okul_isim, okul_eposta, okul_tel, okul_il, okul_ilce, okul_adres, sifre, rol) VALUES ('$okulisim', '$eposta', '$telefon', '$İl', '$İlce', '$Adres', '$sifre', 'okul')";
              
                    if (mysqli_query($conn, $sql)) {
                      // Kayıt işlemi başarılı, başka bir sayfaya yönlendir
                      echo'<script>window.location.href="okulgiris.php";</script>';
                      exit();
                    } else {
